...
function DroneControll({ bat, rc, index, ws, frame, setFrame, pathLen,
	...
	<>
		<div className="col-span-1 grid grid-cols-5 gap-x-0.5 p-0 bg-stone-800" >
			...
			{/* Trim telemetry */}
			<div className="col-span-1 bg-stone-700 p-2 flex flex-col">
				<Progression rc={rc} arg={0} color={"red"}/>
				<Progression rc={rc} arg={1} color={"purple"}/>
				<Progression rc={rc} arg={2} color={"blue"}/>
				<Progression rc={rc} arg={3} color={"cyan"}/> 
				<Progression rc={rc} arg={4} color={"green"}/>
			</div>
			...
			{/* Setpoint2D */}
			<div className="col-span-1 bg-stone-700 p-2 flex flex-col">
				<Setpoint2d index={index} ws={ws} setpoint={setpoint} />
			</div>
